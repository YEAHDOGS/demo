...
| 2026-09-09 | **#4 Domain: staging lives at the project path for now.** Custom-domain candidates (`work.wearedogs.net`, a path on the main domain) stay user's call in roadmap Phase 4 — the site is built so the base path is one config line to change. | Jack |
